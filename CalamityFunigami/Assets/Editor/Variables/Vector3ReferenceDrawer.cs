...
namespace Calamity.Primitives
{
    ...
    public class Vector3ReferenceDrawer : PropertyDrawer
    {
        ...
        private readonly string[] popupOptions =
            { "Use Constant", "Use Composite", "Use Variable" };
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty useFormula = property.FindPropertyRelative("UseComposite");
            SerializedProperty formula = property.FindPropertyRelative("CompositeVector3");
