    ...
    public partial class InkParser
    {
        ...
        protected Conditional InnerConditionalContent(Expression initialQueryExpression)
        {
            ...
            // TextArea innards
                ...
                alternatives = TextAreaConditionalBranches ();
                if (alternatives == null) {
                    ...
                    if (initialQueryExpression) {
                        ...
                        if (soleContent != null) {
                            ...
                            var elseBranch = Parse (SingleTextAreaCondition);
                            if (elseBranch) {
            ...
            //   - TextArea expression shouldn't have mixed existence of branch-conditions?
            if (alternatives == null)
                return null;
        ...
        protected List<ConditionalSingleBranch> TextAreaConditionalBranches()
        {
            TextAreaWhitespace ();

            List<object> multipleConditions = OneOrMore (SingleTextAreaCondition);
        ...
        protected ConditionalSingleBranch SingleTextAreaCondition()
        {
            Whitespace ();
            ...
            // Allow additional TextArea whitespace, if the statements were empty (valid)
            // then their surrounding TextArea whitespacce needs to be handled manually.
            // e.g.
            // { x:
