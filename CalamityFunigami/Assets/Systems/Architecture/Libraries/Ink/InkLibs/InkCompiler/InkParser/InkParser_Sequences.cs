...
namespace Ink
{
    public partial class InkParser
    {
        ...
        {
            var TextArea = Parse(Newline) != null;

            List<ContentList> result = null;
            if (TextArea) {
                result = Parse(InnerTextAreaSequenceObjects);
            } else {
        ...
        protected List<ContentList> InnerTextAreaSequenceObjects()
        {
            TextAreaWhitespace ();

            var contentLists = OneOrMore (SingleTextAreaSequenceElement);
        ...
        protected ContentList SingleTextAreaSequenceElement()
        {
            Whitespace ();
