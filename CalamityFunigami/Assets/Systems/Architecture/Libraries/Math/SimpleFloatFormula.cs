...
{
    [CreateAssetMenu(menuName = AssetMenuSortOrders.MathPath + "SimpleFloatFormula", fileName = "SimpleFloatFormula", order = AssetMenuSortOrders.MathOrder + 4)]
    public class SimpleFloatFormula : MathFormula<float>
    {
        [SerializeField] private FloatReference _parameter1;
